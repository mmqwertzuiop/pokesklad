        ...
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
          ...
          <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              { icon: Eye, val: totalTracked, label: 'SLEDOVANÝCH' },
          ...
          <div className="mb-5 flex flex-col gap-2 sm:flex-row">
            <div className="relative flex-1">
              ...
              <Input placeholder="Hľadať produkt..." value={search} onChange={(e) => setSearch(e.target.value)}
            ...
            <Select value={category} onValueChange={(v) => setCategory(v ?? 'all')}>
              ...
              <SelectContent><SelectItem value="all">Všetky</SelectItem><SelectItem value="etb">ETB</SelectItem><SelectItem value="booster_box">Booster Box</SelectItem><SelectItem value="booster_pack">Booster Pack</SelectItem><SelectItem value="booster_bundle">Booster Bundle</SelectItem><SelectItem value="collection_box">Collection Box</SelectItem></SelectContent>
            </Select>
            <Select value={sort} onValueChange={(v) => setSort(v ?? 'updated_at')}>
              ...
              <SelectContent><SelectItem value="updated_at">Najnovšie</SelectItem><SelectItem value="current_price">Najlacnejšie</SelectItem><SelectItem value="name">Názov</SelectItem></SelectContent>
            </Select>
          </div>
          ...
          <div className="mb-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-label text-[9px] uppercase tracking-wider text-[#a78bfa]">PRÁVE SKLADOM</span>
            </div>
            <span className="font-label text-[9px] text-[#475569]">{total} VÝSLEDKOV</span>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-xl py-20 card-v">
              ...
              <h3 className="font-heading text-xl text-[#64748b]">ŽIADNE PRODUKTY</h3>
              <p className="mt-1 text-xs text-[#475569]">Skúste zmeniť filtre</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="mt-10 rounded-xl p-6 text-center card-v">
            <h3 className="font-heading text-xl text-white">CHCEŠ VEDIEŤ O DOSKLADNENÍ AKO PRVÝ?</h3>
            <p className="mt-1 text-xs text-[#64748b]">Zaregistruj sa a dostaneš notifikáciu do 5 minút.</p>
            <Button className="mt-4 font-label text-[10px] uppercase tracking-wider bg-[#8b5cf6] hover:bg-[#7c3aed] text-white" render={<Link href="/register" />}>
              REGISTROVAŤ SA <ArrowRight className="ml-1 h-3 w-3" />
            </Button>
          </div>
        </div>
      </main>
